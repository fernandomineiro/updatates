          ...
          <div class="box box-primary">
            ...
            <form role="form" action="" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Digite o telefone</label>
                  <input type="text" class="form-control" name="telefone" data-inputmask='"mask": "99999999999"' data-mask id="exampleInputEmail1" placeholder="Digite o telefone">
                </div>
...
$telefone   = $_POST["telefone"];
      ...
      curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => "{\"destination\": \"55$telefone\" ,  \"messageText\": \"$texto\"}",
...
if ($err) {
  ...
  echo"enviado com sucesso para o número $telefone";
}   
}
